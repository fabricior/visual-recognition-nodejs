...
1. View the application in a browser at `localhost:4701`
...
## Environment Variables
  ...
  - `PORT` : The port the server should run on. *(optional, defaults to 4701)*
...
locally, so the base URL is `http://localhost:4701` and then you train
...
`http://localhost:4701/train#SatelliteImagery_859438478` and use the
